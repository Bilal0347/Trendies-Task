...
export default async function ProductDetailPage({ params }: PageProps) {
  try {
    ...
    console.log('Product found:', { id: product.id, name: product.name }); // Log successful product fetch
    ...
    if (ratingsError) {
      ...
      ratings = ratingsData || [];
      console.log('Ratings fetched:', { count: ratings.length }); // Log ratings count
    }
    ...
    console.error('Unexpected error in ProductDetailPage:', error);
